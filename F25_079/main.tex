...
\begin{center}
\vspace*{2cm}
{\Huge \bfseries \fyptitle \par}
\vspace{2cm}
{\Large \degree\ Thesis \par}
\vfill
Supervisors: \supervisor, \cosupervisor \par
Students: \Studentone, \Studenttwo, \Studentthree \par
\university \par
\today
\end{center}
\end{titlepage}
